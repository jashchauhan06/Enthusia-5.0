...
const Hero = () => {
    ...
    const frameCount = 68;
    const startFrame = 5;
    const framePrefix = '/strangertech-app/intro_mp4_000/intro_mp4_';
    ...
    const renderFrame = (index) => {
        ...
        try {
            ...
            console.warn('Error rendering frame:', index, error);
        }
    };
    ...
    return (
        <section className="hero-sequence" id="hero" ref={heroSectionRef}>
            {/* Loading Screen */}
            <div className="sequence-loader" id="sequenceLoader" ref={loaderRef}>
                ...
                <div className="loader-content">
                    <div className="loader-logo">
                        <img src="/strangertech-app/Stranger Tech logo.webp" alt="Stranger Tech Logo" />
                    </div>
