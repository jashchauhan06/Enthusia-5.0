    ...
    return (
        <nav className="navbar" id="navbar" ref={navbarRef}>
            ...
            <ul className="nav-links" id="navLinks">
                <li><a href="#hero" className="active magnetic" data-strength="0.2">HOME</a></li>
                <li><a href="#about" className="magnetic" data-strength="0.2">ABOUT</a></li>
                <li><a href="#challenge1" className="magnetic" data-strength="0.2">ROUNDS</a></li>
                ...
                <li><a href="#requirements" className="magnetic" data-strength="0.2">PRIZES</a></li>
            ...
            <div className="nav-logos">
                <a href="https://sitnagpur.edu.in/" target="_blank" rel="noopener noreferrer" className="nav-logo-link magnetic" data-strength="0.3">
                    <img src="/strangertech-app/Sit logo.webp" alt="SIT Logo" className="nav-sit-logo" />
                </a>
                <a href="#" target="_blank" rel="noopener noreferrer" className="nav-logo-link magnetic" data-strength="0.3">
                    <img src="/strangertech-app/iic-logo.webp" alt="IIC Logo" className="nav-iic-logo" />
                </a>
            </div>
        </nav>
    );
