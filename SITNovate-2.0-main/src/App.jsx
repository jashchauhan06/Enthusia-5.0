...
function App() {
  ...
  const handleLoadComplete = () => {
    setIsLoading(false);
    // Trigger audio play after loading screen with a slight delay
    setTimeout(() => {
  ...
  useEffect(() => {
    ...
    const onWheel = (e) => {
      ...
      const scrollableContainer = e.target.closest('.scrollbar-custom');
      ...
      if (scrollableContainer) {
        ...
        // Only prevent default and change sections if at boundaries
