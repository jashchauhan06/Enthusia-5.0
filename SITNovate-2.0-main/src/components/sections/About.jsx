...
export default function About() {
    ...
    return (
        <section
            id="about"
            className="min-h-screen md:h-screen w-full bg-gradient-to-br from-[#0a0a0f] via-[#050505] to-[#0f0a05] text-[#d4cfc3] selection:bg-[#3d2b1f] selection:text-[#d4af37] flex items-center justify-center overflow-visible md:overflow-hidden snap-start relative pt-32 pb-20 md:py-0"
            ref={containerRef}
        ...
        >
            ...
            {/* Ornate Frame (Desktop) */}
            <div className="hidden md:block absolute inset-0 w-full h-full pointer-events-none">
                <OrnateFrame />
            </div>

            {/* Content Container (Improved Mobile Dimensions) */}
            <div className="relative z-10 w-[92vw] md:w-full max-w-5xl p-6 md:p-16 border border-[#d4af37]/30 md:border-none my-12 md:my-0 rounded-xl md:rounded-none bg-black/60 md:bg-transparent shadow-2xl md:shadow-none">
                <div className="w-full float-animation">

                    {/* Title Section */}
                    <div className="flex flex-col items-center gap-4 md:gap-6 mb-8 md:mb-12">
                        <h2 className="text-3xl md:text-6xl font-cinzel tracking-[0.2em] text-center font-bold text-[#d4af37] drop-shadow-[0_0_15px_rgba(212,175,55,0.5)] animate-fade-in-up uppercase leading-tight">
                            About <br className="md:hidden" /> SITNovate 2.0
                        </h2>
                    ...
                    <div className="space-y-6 md:space-y-8 text-[#c0c0c8] text-sm md:text-lg leading-relaxed font-sans text-center px-2 md:px-12">
                        ...
                        <div className="mt-8 md:mt-16 pt-8 md:pt-12 border-t border-[#d4af37]/20 flex flex-wrap justify-center gap-x-12 md:gap-x-24 gap-y-8 md:gap-y-12 font-cinzel tracking-widest text-[10px] md:text-xs uppercase">
                            ...
                            <div className="w-px h-12 md:h-16 bg-gradient-to-b from-transparent via-[#d4af37]/50 to-transparent hidden md:block"></div>

                            <div className="flex flex-col items-center gap-2 md:gap-3 stat-glow cursor-default group">
                                <span className="text-3xl md:text-5xl text-[#d4af37] group-hover:scale-110 transition-transform duration-300 font-bold">1 LAKH+</span>
                                <span className="opacity-70 group-hover:opacity-100 text-[#c0c0c8] tracking-[0.15em] md:tracking-[0.3em]">PAST YEAR'S PRIZE POOL</span>
                            </div>
                        </div>
                    </div>
                </div>
