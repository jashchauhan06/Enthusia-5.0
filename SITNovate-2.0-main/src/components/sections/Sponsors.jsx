...
const Sponsors = () => {
    const sponsors = [
        { name: "All That's Coffee", src: `${import.meta.env.BASE_URL}assets/images/sponsors/ATC.jpeg` },
        { name: "Insterra", src: `${import.meta.env.BASE_URL}assets/images/sponsors/Insterra.webp` },
        { name: "MIA", src: `${import.meta.env.BASE_URL}assets/images/sponsors/MIA.png` },
        { name: "PB Creators", src: `${import.meta.env.BASE_URL}assets/images/sponsors/PB.png` },
        { name: "Devfolio", src: `${import.meta.env.BASE_URL}assets/images/sponsors/dev.png` },
        { name: "ETHIndia", src: `${import.meta.env.BASE_URL}assets/images/sponsors/eth.png` },
        { name: "Pizza Hut", src: `${import.meta.env.BASE_URL}assets/images/sponsors/pizzahut.png` },
        { name: "Polygon", src: `${import.meta.env.BASE_URL}assets/images/sponsors/poly.png` },
        { name: "Unstoppable Domains", src: `${import.meta.env.BASE_URL}assets/images/sponsors/un.png` },
    ];
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-6xl flex flex-col items-center">
                ...
                <div className="mt-12 md:mt-16 flex flex-col items-center animate-pulse-slow">
                    <p className="text-[#a0a0a0] font-cinzel text-[10px] md:text-base tracking-widest mb-4 opacity-80 text-center uppercase px-4">Interested in Sponsoring SITNovate 2.0 (2026)?</p>
                    <Link
                        to="/sponsor-us"
                        className="relative px-6 md:px-8 py-3 overflow-hidden group bg-transparent border border-[#d4af37] text-[#d4af37] font-cinzel tracking-[0.2em] uppercase transition-all duration-300 hover:bg-[#d4af37] hover:text-[#050505] hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] text-xs md:text-sm"
                    >
                        <span className="relative z-10">Sponsor Us</span>
                        <div className="absolute inset-0 bg-[#d4af37] transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300 ease-out z-0"></div>
                    </Link>
                </div>
