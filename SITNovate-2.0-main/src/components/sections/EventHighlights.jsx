...
const EventHighlights = () => {
    ...
    const images = [
        {
            src: `${import.meta.env.BASE_URL}assets/images/sitnovate/1.JPG`,
        ...
        {
            src: `${import.meta.env.BASE_URL}assets/images/sitnovate/2.JPG`,
        ...
        {
            src: `${import.meta.env.BASE_URL}assets/images/sitnovate/3.jpg`,
        ...
        {
            src: `${import.meta.env.BASE_URL}assets/images/sitnovate/4.jpg`,
            label: "Evaluators",
        ...
        {
            src: `${import.meta.env.BASE_URL}assets/images/sitnovate/5.png`,
        ...
        {
            src: `${import.meta.env.BASE_URL}assets/images/sitnovate/6.png`,
        ...
        {
            src: `${import.meta.env.BASE_URL}assets/images/sitnovate/7.jpg`,
            label: "Winners",
