...
const Hero = () => {
    ...
    return (
        <section id="hero" className="w-full h-screen relative flex items-center justify-center snap-start">
            ...
            <div className="z-20 w-full max-w-4xl px-6 flex flex-col items-center -mt-32 md:-mt-16">
                ...
                >
                    <ImageSkeleton
                        ...
                        alt="SITNovate Logo"
                        className="w-full max-w-xs md:max-w-xl object-contain drop-shadow-[0_0_15px_rgba(212,175,55,0.3)]"
            ...
            {/* Go Back Button */}
            <motion.button
                className="absolute bottom-20 md:bottom-8 left-8 z-20 px-4 py-2 bg-black/30 backdrop-blur-sm border border-[#d4af37]/30 text-[#d4af37] font-cinzel text-sm tracking-wider hover:bg-[#d4af37]/10 hover:border-[#d4af37]/60 transition-all duration-300 rounded-lg"
