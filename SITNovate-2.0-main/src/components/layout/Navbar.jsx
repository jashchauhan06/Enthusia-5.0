    ...
    return (
        <>
            ...
            <header className="fixed top-0 left-0 w-full z-[100] flex justify-between items-start px-1 py-2 md:px-2 md:py-3 pointer-events-none">
                ...
                <audio ref={audioRef} loop src={`${import.meta.env.BASE_URL}assets/audio/ambience.webm`} />
            </header>
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    ...
                    >
                        ...
                        >
                            <Link to="/sponsor-us" className="hover:text-hp-gold">Sponsor Us</Link>
                            <Link to="/terms-of-use" className="hover:text-hp-gold">Terms of Use</Link>
                            <Link to="/privacy-policy" className="hover:text-hp-gold">Privacy Policy</Link>
                        </motion.div>
                    </motion.div>
                )}
            </AnimatePresence>
