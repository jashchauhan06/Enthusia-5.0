    ...
    >
      {[...Array(10)].map((_, i) => (
        <React.Fragment key={i}>
          <span>
            SITank 2.0 <span className="text-green-500">▲ ₹400.00</span>
          </span>
          <span>
...
export const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      "Yes, there is a registration fee of ₹400 per team for each event (Dalal Street and The Boardroom Battle).",
  },
  {
