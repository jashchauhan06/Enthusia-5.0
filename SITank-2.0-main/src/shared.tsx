...
export const STUDENT_DATA = [
  ...
  },
  {
    name: "Tanay Kothari",
    role: "Event Coordinator",
    image: "/sitank-app/images/team/Tanay Kothari.webp",
    phone: "+91 99755 78363",
    email: "tanay.kothari.btech2023@sitnagpur.siu.edu.in",
  },
  { name: "Ojas Charjan", 
    role: "Event Coordinator", 
    image: "/sitank-app/images/team/Ojas.webp",
  ...
  },
  {
    name: "Kunjal Pise",
    role: "Event Coordinator",
    image: "/sitank-app/images/team/Kunjal Pise.webp",
  ...
  },
  {
    name: "Varun Mundhada",
    role: "Event Coordinator",
    image: "/sitank-app/images/team/Varun Mundhada.webp",
  ...
  },
  {
    name: "Parth Tiwaskar",
    role: "Event Coordinator",
    image: "/sitank-app/images/team/Parth Tiwaskar.webp",
    phone: "+91 9112374118",
...
export const JURY_DATA = [
  {
    ...
    image: "/sitank-app/images/jury/Amit Badiyani.webp",
  ...
  },
  {
    ...
    image: "/sitank-app/images/jury/Abhay Deshmukh.webp",
  ...
  },
  {
    ...
    image: "/sitank-app/images/jury/Rohit Chinchanikar.webp",
    linkedin: "https://www.linkedin.com/in/rohit-chinchanikar-a7b3a0158/",
    instagram: "https://www.instagram.com/rohit_chinchanikar/",
  },
  {
    name: "Mr. Abhishek Sharma",
    title: "Founder & CEO dmodot",
    bio: "Abhishek Sharma is the founder and CEO of dmodot, a New Delhi–based handcrafted luxury footwear label blending Indian artisanal shoemaking with clean, modern design. Known online as chiefxdot, he has built dmodot into a “Made in India” luxury brand featured on Disney+ Hotstar’s “Pitch To Get Rich” where its growth story and craftsmanship were showcased to a national audience.",
    image: "/sitank-app/images/jury/Abhishek Sharma.webp",
    linkedin: "https://www.linkedin.com/in/abhishek-sharma-25896345/",
    instagram: "https://www.instagram.com/chiefxdot/",
  },
];
...
export const HeroVideoBackground = () => (
  <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
    ...
    <div
      ...
      style={{
        backgroundImage: "url('/sitank-app/images/bg.webp')",
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          ...
          >
            <div className="relative w-[280px] h-[200px] md:w-[600px] md:h-[400px] bg-[#1a1612] p-2 shadow-[20px_20px_0px_rgba(0,0,0,0.5)] border border-[#5c4d3c] transform -rotate-2 hover:rotate-0 transition-transform duration-500">
              <SmartImage 
                src="/sitank-app/images/about_photo.webp" 
                alt="SITank Event" 
                fit="cover" 
  ...
  <div className="mb-40">
    <div className="max-w-4xl mx-auto">
      <div className="relative border-4 border-[#d4b483] bg-[#1a1612] p-4 shadow-[12px_12px_0px_#2c241b] hover:shadow-[16px_16px_0px_#2c241b] hover:-translate-y-1 transition-all duration-300">
        ...
        <SmartImage
          src="/sitank-app/images/sitank/poster.webp"
