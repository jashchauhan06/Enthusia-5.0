...
const CRITICAL_IMAGES = [
  '/images/card_bg.png',
  '/images/mask.png',
  '/images/money_heist_bg.png',
  '/dev-favicon.svg',
  '/images/team/Sunidhi.jpg',
  '/images/team/Prathmesh.png',
  '/images/team/Jash.jpg',
  '/images/team/Soumya.png',
  '/images/sponsors/pizzahut.png',
  '/images/sponsors/MIA.png',
  '/images/sponsors/Insterra.webp',
  '/images/sponsors/PB.png',
  '/images/sponsors/dev.png',
  '/images/sponsors/eth.png',
  '/images/sponsors/poly.png',
  '/images/sponsors/un.png',
  '/images/sponsors/R.png',
  '/images/sponsors/ATC.jpeg',
];

// Additional images that can be loaded after critical ones
const SECONDARY_IMAGES = [
  '/images/team/Parth Choudhari.jpg',
  '/graph-profile-dev.jpg',
  '/Black Magic Wand & Magic Ball 3D--cursor--SweezyCursors.png',
];
