...
const CRITICAL_IMAGES = [
  `${import.meta.env.BASE_URL}images/card_bg.png`,
  `${import.meta.env.BASE_URL}images/mask.png`,
  `${import.meta.env.BASE_URL}images/money_heist_bg.png`,
  `${import.meta.env.BASE_URL}dev-favicon.svg`,
  `${import.meta.env.BASE_URL}images/team/Sunidhi.jpg`,
  `${import.meta.env.BASE_URL}images/team/Prathmesh.png`,
  `${import.meta.env.BASE_URL}images/team/Jash.jpg`,
  `${import.meta.env.BASE_URL}images/team/Soumya.png`,
];
