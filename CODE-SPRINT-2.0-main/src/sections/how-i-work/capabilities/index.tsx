...
export function Capabilities() {
  ...
  return (
    <div className="w-full h-full text-[#f2f2f2] flex flex-col">
      <h3 className="font-heading text-xl mb-4 md:mb-0">Prizes & Rewards</h3>
      ...
      <div>
        <p className="font-body font-light text-sm text-[#b3b3b3] mb-2">
          Plus mentorship & networking opportunities
        </p>
        <button 
          onClick={handleLetsTalkClick}
          className="flex items-center gap-2 font-heading text-[#f2f2f2] hover:opacity-80 transition-opacity cursor-pointer"
        >
          View All Prizes
