      ...
      <div className="w-full h-[700px]">
        <div className="grid grid-cols-1 [@media(min-width:1390px)]:grid-cols-3 grid-rows-[1fr_auto] [@media(min-width:1390px)]:grid-rows-none gap-2 [@media(min-width:1390px)]:gap-6 h-full">
          ...
          <div className="[@media(min-width:1390px)]:col-span-2 flex flex-col gap-6 h-full">
            ...
            <div 
              ref={bottomBarRef}
              className="bg-black border border-[#353739] rounded-[2rem] p-4 [@media(min-width:1390px)]:p-6 transition-all duration-300 ease-in-out hover:border-[#555759] hover:-translate-y-0.5 flex-none [@media(min-width:1390px)]:mb-0 mb-3"
            >
              <BottomBar />
            </div>
          </div>
