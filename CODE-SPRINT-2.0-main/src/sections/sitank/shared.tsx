...
export const STUDENT_DATA = [
    { name: "Sunidhi Haware", role: "President", alias: "TOKYO", image: `${import.meta.env.BASE_URL}images/team/Sunidhi.jpg` },
    { name: "Prathmesh Raipurkar", role: "Vice President", alias: "BERLIN", image: `${import.meta.env.BASE_URL}images/team/Prathmesh.png` },
    { name: "SHLOK VIJ", role: "Event Lead", alias: "The Professor", image: `${import.meta.env.BASE_URL}images/team/SHLOK.jpeg` },
    { name: "SHRUTI BAWANKAR", role: "Event Lead", alias: "Nairobi", image: `${import.meta.env.BASE_URL}images/team/SHRUTI.jpg` },
    { name: "Jash Chauhan", role: "Web Development Team Lead", alias: "RIO", image: `${import.meta.env.BASE_URL}images/team/Jash.jpg` },
    { name: "Soumya Mishra", role: "Developer", alias: "HELSINKI", image: `${import.meta.env.BASE_URL}images/team/Soumya.png` },
];
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ backgroundImage: `url('${import.meta.env.BASE_URL}images/card_bg.png')` }}
            >
                {/* Bullet holes */}
...
export const HeroVideoBackground = () => (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        >
            ...
            <source src={`${import.meta.env.BASE_URL}videos/sitank.mp4`} type="video/mp4" />
        </video>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div className="relative w-[280px] h-[200px] md:w-[600px] md:h-[400px] bg-[#1a1612] p-2 shadow-[20px_20px_0px_rgba(0,0,0,0.5)] border border-[#5c4d3c] transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                            <SmartImage src={`${import.meta.env.BASE_URL}images/ashneer-grover.png`} alt="Guest_Photo" fit="cover" />
