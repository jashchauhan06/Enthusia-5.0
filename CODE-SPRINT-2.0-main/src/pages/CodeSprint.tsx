    ...
    return (
        <>
            <audio ref={audioRef} loop>
                <source src={`${import.meta.env.BASE_URL}audio/bella-ciao.mp3`} type="audio/mpeg" />
            </audio>
            <AnimatePresence>
                {isVisible && (
                    <motion.button
...
const HeroVideoBackground = () => (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <img
            src={`${import.meta.env.BASE_URL}images/money_heist_bg.png`}
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 px-4">
                    <motion.div style={{ y: textY }}>
                        ...
                        <div className="flex gap-6 justify-center">
                            {/* Go Back Button */}
                            <motion.button
                                onClick={() => window.open('https://enthusia-5-0.netlify.app/#techfest-events', '_blank')}
                                className="relative group"
                                whileHover={{ scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                            >
                                {/* Outer glow */}
                                <div className="absolute -inset-1 bg-gray-600/50 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                                {/* Main button container */}
                                <div className="relative bg-black border-2 border-gray-600 px-12 py-6 transform -skew-x-6 overflow-hidden">
                                    {/* Animated background stripes */}
                                    <div className="absolute inset-0 opacity-20">
                                        <div className="absolute inset-0 bg-[repeating-linear-gradient(90deg,transparent,transparent_10px,rgba(156,163,175,0.3)_10px,rgba(156,163,175,0.3)_20px)] animate-slide" />
                                    </div>
                                    ...
                                    {/* Corner brackets */}
                                    <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-gray-500" />
                                    <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-gray-500" />
                                    <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-gray-500" />
                                    <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-gray-500" />
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-zinc-800">
                                        <motion.div
                                            className="h-full bg-gradient-to-r from-gray-600 via-gray-500 to-gray-600"
                                            animate={{ x: ["100%", "-100%"] }}
                                ...
                                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity">
                                    <div className="absolute inset-0 bg-gray-600/10 transform translate-x-1 -translate-y-1 -skew-x-6" />
                                    <div className="absolute inset-0 bg-blue-500/10 transform -translate-x-1 translate-y-1 -skew-x-6" />
                                </div>
                            </motion.button>
                                ...
                                <div className="relative bg-black border-2 border-red-600 px-16 py-6 transform -skew-x-6 overflow-hidden">
                                    ...
                                    <div className="relative skew-x-6 flex items-center gap-4">
                                        ...
                                        <div className="w-10 h-10 rounded-full bg-red-600 flex items-center justify-center overflow-hidden">
                                            <img src={`${import.meta.env.BASE_URL}images/mask.png`} alt="Dali Mask" className="w-8 h-8 object-contain" />
                                        </div>
                    ...
                    <div className="mb-40 grid lg:grid-cols-2 gap-16 items-center" id="about">
                        <div className="bg-black p-10 border-l-8 border-red-600 shadow-2xl relative">
                            ...
                            <p className="text-lg text-zinc-400 leading-relaxed font-mono mb-6">
                                Money Heist x CodeSprint 2.0 drops your team inside a high-security bank with one goal — pull off the perfect heist . Guided by the Professor’s plan, you’ll work in phases: gather intelligence and plan, execute the heist, and finally escape the bank, adapting to twists along the way! One smart move can change everything, one mistake can cost you - the only question is, can your team pull off the biggest bank heist and make it out clean?
                            </p>
                        </div>
                        ...
                        <div className=" h-[500px] border-4 border-white bg-black p-2 shadow-2xl transform rotate-3 hover:rotate-0 transition-all duration-500 grayscale hover:grayscale-0">
                            <SmartImage src={`${import.meta.env.BASE_URL}images/about_image.jpeg`} alt="About" className="object-cover h-full w-full" />
                        </div>
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <div className="bg-black border border-zinc-800 p-10 relative group hover:border-red-600 transition-colors">
                                ...
                                <div className="space-y-3 font-mono text-zinc-400">
                                    ...
                                    {["Registration Fee: ₹180/- per team upon shortlisting", "Masks & Swags", "Institute Certificates"].map((item, i) => (
                                ...
                                {MARQUEE_DATA.map((img, idx) => (
                                    ...
                                    >
                                        <div className="h-full w-full relative overflow-hidden bg-black">
                                            <SmartImage src={`${import.meta.env.BASE_URL}images/highlights/${img.index}.${img.ext}`} alt="Evidence" fit="cover" className="w-full h-full object-cover" />
                                        </div>
                                    </div>
                                ))}
                            </motion.div>
                            ...
                            <div className="relative bg-black border-2 border-red-600 px-16 py-6 transform -skew-x-6 overflow-hidden">
                                ...
                                <div className="relative skew-x-6 flex items-center justify-center gap-4">
                                    ...
                                    <div className="w-12 h-12 rounded-full bg-red-600 flex items-center justify-center overflow-hidden">
                                        <img src={`${import.meta.env.BASE_URL}images/mask.png`} alt="Dali Mask" className="w-10 h-10 object-contain" />
                                    </div>
        ...
        <section className="relative min-h-screen bg-black text-white pt-20 pb-20 px-4 font-sans overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="mb-8 flex flex-col gap-3">
                    ...
                    <motion.button
                        onClick={() => window.open('https://enthusia-5-0.netlify.app/', '_blank')}
                        className="relative group"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                    >
                        <div className="absolute -inset-1 bg-gray-600/40 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        <div className="relative bg-black border-2 border-gray-600 px-6 py-3 transform -skew-x-6 overflow-hidden">
                            <div className="absolute inset-0 opacity-20">
                                <div className="absolute inset-0 bg-[repeating-linear-gradient(90deg,transparent,transparent_8px,rgba(156,163,175,0.3)_8px,rgba(156,163,175,0.3)_16px)] animate-slide" />
                            </div>
                            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/5 to-transparent animate-scan pointer-events-none" />
                            ...
                            <div className="relative skew-x-6 flex items-center justify-center gap-3">
                                ...
                                <div className="flex flex-col items-start">
                                    <span className="text-[8px] text-gray-500 font-mono tracking-[0.2em] uppercase">Exit Route</span>
                                    <span className="text-sm font-black text-white uppercase tracking-wider">GO BACK</span>
                                </div>
                            </div>
                            <div className="absolute bottom-0 left-0 right-0 h-1 bg-zinc-800">
                                <motion.div
                        ...
                        <div className="relative bg-black border-2 border-red-600 px-8 py-4 transform -skew-x-6 overflow-hidden">
                            ...
                            <div className="relative skew-x-6 flex items-center justify-center gap-4">
                                <div className="w-8 h-8 rounded-full bg-red-600 flex items-center justify-center overflow-hidden">
                                    <img src={`${import.meta.env.BASE_URL}images/mask.png`} alt="Dali Mask" className="w-6 h-6 object-contain" />
                                </div>
                                <div className="flex flex-col items-start">
                ...
                <div className="mb-12 grid gap-6">
                    <div className="bg-zinc-900 border-l-4 border-red-600 p-6 shadow-xl">
                        ...
                        <p className="text-sm text-zinc-400 leading-relaxed mb-4 font-mono">
                            Money Heist x CodeSprint 2.0 drops your team inside a high-security bank with one goal — pull off the perfect heist. Guided by the Professor's plan, you'll work in phases: gather intelligence and plan, execute the heist, and finally escape the bank, adapting to twists along the way!
                        </p>
                        <p className="text-sm text-zinc-400 leading-relaxed mb-4 font-mono">
                            One smart move can change everything, one mistake can cost you - the only question is, can your team pull off the biggest bank heist and make it out clean?
                        </p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-black border border-zinc-800 p-6 relative">
                            ...
                            <div className="space-y-2 font-mono text-zinc-400 text-sm">
                                ...
                                {["Registration Fee: ₹180/- per team upon shortlisting", "Consolation: Hampers", "Masks & Swags", "Institute Certificates"].map((item, i) => (
                        ...
                        {HIGHLIGHTS_DATA.slice(0, 4).map((img, idx) => (
                            ...
                            >
                                <div className="aspect-[4/3] w-full bg-black overflow-hidden rounded-sm">
                                    <SmartImage
                                        src={`/images/highlights/${img.index}.${img.ext}`}
                                        alt="Event Highlight"
                                        fit="cover"
                    ...
                    {HIGHLIGHTS_DATA.length > 4 && (
                        <div className="mt-3 sm:mt-4 flex justify-center">
                            <div className="relative bg-white p-1 shadow-lg transform rotate-1 hover:rotate-0 transition-transform duration-300 w-1/2">
                                <div className="aspect-[4/3] w-full bg-black overflow-hidden rounded-sm">
                                    <SmartImage
                                        src={`/images/highlights/${HIGHLIGHTS_DATA[4].index}.${HIGHLIGHTS_DATA[4].ext}`}
                                        alt="Event Highlight"
                                        fit="cover"
                                        className="w-full h-full object-cover"
                                    />
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-black border border-zinc-800 hover:border-red-600 transition-colors p-4 rounded-lg">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    <div className="text-xs text-red-500 font-mono uppercase tracking-wider">Event Lead</div>
                    ...
                    >
                        ...
                        <div className="relative bg-black border-2 border-red-600 px-8 py-4 transform -skew-x-6 overflow-hidden">
                            ...
                            <div className="relative skew-x-6 flex items-center justify-center gap-3">
                                {/* Mask icon */}
                                <div className="w-8 h-8 rounded-full bg-red-600 flex items-center justify-center overflow-hidden">
                                    <img src="/images/mask.png" alt="Dali Mask" className="w-6 h-6 object-contain" />
                                </div>
