...
export const designPlatformData: CaseStudyData = {
  projectData: {
    ...
    title: "ENTHUSIA 4.0",
    description: "Three-day techno-cultural fest | Feb 19-21, 2025 | SIT Nagpur",
    sections: [
      {
        title: "Technical Events Overview",
        items: [
          "• SITNovate 1.0: 24-hour hackathon bringing together innovative minds",
          "• CodeSprint 1.0: Competitive coding challenges for programming enthusiasts", 
          "• Tech Hunt: Tech treasure hunt with exciting challenges",
          "• SITank 1.0: Pitch desk competition for entrepreneurial ventures",
          "• Creative Challenge: Brand advertisement challenge showcasing creativity"
        ]
      },
      {
        title: "Cultural Events Overview", 
        items: [
          "• Cultural performances including dance, drama, and traditional ceremonies",
          "• Music night featuring live performances and collaborative sessions",
          "• Comedy sessions bringing laughter and entertainment",
          "• Celebrity performances with special guest artists",
      ...
      },
      {
        ...
        items: [
          "• Three-day immersive techno-cultural experience from Feb 19-21, 2025",
          "• Perfect blend of technical competitions and cultural celebrations",
          "• Participation of 800+ students from various institutions",
          "• 12+ events spanning both technical and cultural domains",
