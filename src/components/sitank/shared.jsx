...
export const JURY_DATA = [
  ...
  },
  {
    ...
    image: "/images/jury/Abhishek Sharma.webp",
    ...
    >
      {[...Array(10)].map((_, i) => (
        <React.Fragment key={i}>
          <span>
            SITank 2.0 <span className="text-green-500">▲ 500.00</span>
          </span>
          <span>
...
export const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      "Yes, there is a registration fee of ₹400 per team for each event (Dalal Street and The Boardroom Battle). Teams can participate in one or both events.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Dalal Street (Pitch to Win): Present your startup pitch deck to a panel of judges and investors. The Boardroom Battle (Ideathon): A 24-hour innovation challenge where teams build solutions and pitch their MVPs.",
  },
  {
    question: "Do I need a registered startup to participate?",
    answer:
      "No, even idea-stage startups are welcome.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, expert feedback and guidance will be provided by the investor panel.",
  },
];
