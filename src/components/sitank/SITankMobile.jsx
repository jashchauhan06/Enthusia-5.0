...
export const SITankMobile = ({ onGoBack }) => {
    const handleGoBack = () => {
        if (onGoBack) {
            onGoBack();
        } else {
            window.location.href = "https://enthusia-5-0.netlify.app/#techfest-events";
        }
    };
                ...
                <div id="events-mobile" className="mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[#1a1612] p-6 border border-[#5c4d3c] shadow-[8px_8px_0px_#2c241b]">
                            ...
                            <div className="mb-4 bg-[#2c241b] p-4 border border-[#5c4d3c] relative">
                                {/* NEW Badge */}
                                <div className="absolute -top-1 -right-1 bg-red-600 text-white px-2 py-1 font-mono text-[10px] font-bold uppercase tracking-wider transform rotate-12 shadow-[2px_2px_0px_rgba(0,0,0,0.8)] border border-red-800 animate-pulse">
                                    NEW
                                </div>
                                
                                <h4 className="text-lg font-bold text-[#d4b483] mb-3 uppercase tracking-wider font-mono border-b border-[#5c4d3c] pb-2">Problem Statements</h4>
                                <div className="text-[#a89070] font-mono text-sm leading-relaxed">
                                    <a 
                                        href="https://drive.google.com/drive/folders/1RxdLbIw8zekfkaVHBSkidO1xcerwLSqB?usp=sharing"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-[#d4b483] hover:text-[#c2a270] underline transition-colors text-xs"
                                    >
