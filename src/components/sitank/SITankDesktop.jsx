...
export const SITankDesktop = ({ onGoBack }) => {
          ...
          <div id="events" className="mb-40">
            ...
            <div className="grid md:grid-cols-2 gap-12 mx-20">
              ...
              <div className="bg-[#1a1612] p-10 border border-[#5c4d3c] shadow-[10px_10px_0px_#2c241b] relative flex flex-col">
                ...
                <div className="mb-6 bg-[#2c241b] p-6 border border-[#5c4d3c] relative">
                  {/* NEW Badge */}
                  <div className="absolute -top-2 -right-2 bg-red-600 text-white px-3 py-1 font-mono text-xs font-bold uppercase tracking-wider transform rotate-12 shadow-[3px_3px_0px_rgba(0,0,0,0.8)] border-2 border-red-800 animate-pulse">
                    NEW
                  </div>
                  
                  <h3 className="text-xl font-bold text-[#d4b483] mb-4 uppercase tracking-wider font-mono border-b border-[#5c4d3c] pb-2">
                    Problem Statements
                  </h3>
                  <div className="text-[#a89070] font-mono text-sm leading-relaxed">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#d4b483] hover:text-[#c2a270] underline transition-colors"
                    >
