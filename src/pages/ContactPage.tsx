...
function Contact() {
  ...
  const contactData = [
    ...
    },
    {
      ...
      content: "src.sit@sitnagpur.siu.edu.in",
      link: "mailto:src.sit@sitnagpur.siu.edu.in",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-4 mb-12">
          {[
            ...
            { icon: "📧", title: "Email", content: "src.sit@sitnagpur.siu.edu.in", gradient: "from-green-500/30 to-emerald-500/20" },
