...
const AcademicIcon = ({ className = "text-cyan-400" }) => (
...
const VisionIcon = ({ className = "text-purple-400" }) => (
  <svg className={`w-8 h-8 ${className}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const InnovationIcon = ({ className = "text-orange-400" }) => (
  <svg className={`w-8 h-8 ${className}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
